...
%
% FORMAT pm_defaults_Exampledata_08
%_______________________________________________________________________
%
% This file is intended for use with the example data set: 
% ExampleData_08 which includes a short EPI time series (10 volumes)
% and the corresponding field map for a geometrically distorted phantom.
%
%_______________________________________________________________________
% pm_defaults_ExampleData_08.m Chloe Hutton 31/01/08
