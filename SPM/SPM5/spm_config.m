...
% John Ashburner
% $Id: spm_config.m 2930 2009-03-24 10:30:13Z vladimir $
...
stat    = struct('type','repeat','name','Stats','tag','stats',...
          'values',{{spm_config_fmri_spec,spm_config_fmri_design,spm_config_fmri_data,spm_config_factorial_design,spm_config_fmri_est,spm_config_contrasts,spm_config_results}},...
          'help',{'Various analysis utilities.'});

utils   = struct('type','repeat','name','Util','tag','util',...
          'values',{{spm_config_display,spm_config_checkreg,spm_config_imcalc,spm_config_reorient,...
