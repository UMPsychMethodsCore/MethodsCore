...
% $Id: cat_conf_stools.m 1120 2017-03-21 10:01:35Z gaser $
%_______________________________________________________________________
...
% surface ROI files
  ...
  if expert 
    ...
    ROIs.ufilter = 'lh.aparc_[a2009s|DK40].*'; % not yet working for all atlases
  end
...
% ROI files
  ...
  if expert 
    ...
    s2r.ROIs.ufilter = 'lh.aparc_(a2009s|DK40).*'; % not yet working for all atlases
  end
