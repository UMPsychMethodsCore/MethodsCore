...
% Christian Gaser
% $Id: cat_vol_slice_overlay.m 1068 2016-11-08 11:42:44Z gaser $
...
if nargin == 0
  ...
  imgs = spm_select(2, 'image', 'Select additional overlay image',{fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm/Template_T1_IXI555_MNI152.nii')});
