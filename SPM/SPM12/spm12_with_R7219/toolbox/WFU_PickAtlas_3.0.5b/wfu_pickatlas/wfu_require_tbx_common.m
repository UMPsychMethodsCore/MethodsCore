...
try
  ...
  WFU_LOG.minutia('Entered function $Revision: 3.1 $');
end  
...
if exist(fileOnlyInCommonToolBox)==2
  ...
  [p f e] = fileparts(tbx); %removes wfu_pickatklas.m
  [p f e] = fileparts(p);   %removes wfu_pickatklas directory
...
Revision 3.1  2015/02/23 14:05:55  fmri
removed try/catch fileparts mess

Revision 3.0  2011/10/20 14:22:47  bwagner
Moved to production from WFU_Development

Revision 1.8  2011/10/10 16:58:45  bwagner
