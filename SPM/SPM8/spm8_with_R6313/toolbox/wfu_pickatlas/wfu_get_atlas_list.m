...
%		disp(sprintf('looking at file: %s%s',atlas_path,ImageName));
    iheader=spm_vol([atlas_path ImageName]);
    atlas=spm_read_vols(iheader);
    Atlas.Name=AtlasName;
    Atlas.Iheader=iheader;
    Atlas.Atlas=atlas;
    Atlas.Offset=Offset;
