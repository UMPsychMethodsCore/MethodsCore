...
text('units', 'normalized', 'string', 'GroupICAT v3.0a', 'position', titlePos, 'fontsize', subtitleFont, 'HorizontalAlignment', 'center', ...
...
% authors
giftInfo = {'', '', ['\bfRelease Date: \rm', num2str('21-May-2013')], '', str2mat('\bfAuthors: \rm\bfVince Calhoun, \rm\bfTom Eichele, \rm\bfEric Egolf &', '                \rm\bfSrinivas Rachakonda'), ...
