...
inputText(numParameters).answerString =  char('2', '3');
inputText(numParameters).uiType = 'popup';
inputText(numParameters).dataType = 'numeric';
...
inputText(numParameters).value = 1;
inputText(numParameters).flag = 'scalar';
inputText(numParameters).help = struct('title', 'Group ICA Analysis Type', 'string', char('1) Regular - ICA is run only once on the data.', ...
