...
inputText(numParameters).promptString = 'Enter min cluster size to get the most stable run.';
inputText(numParameters).uiType = 'edit';
...
inputText(numParameters).promptString = 'Enter max cluster size to get the most stable run.';
inputText(numParameters).uiType = 'edit';
