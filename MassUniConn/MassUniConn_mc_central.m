...
switch matrixtype
  ...
  case 'nodiag'
    ...
    a.tvalues(overlap & a.tvalues==2) = 5; % set places with two 2's to 5 to enable twin shading
    a.tvalues(overlap & a.tvalues==3) = 6; % set places with two 3's to 6 to enable twin shading
