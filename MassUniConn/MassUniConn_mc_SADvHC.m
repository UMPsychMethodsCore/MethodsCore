...
des.csvpath = '/net/pizza/CAAD/Scripts/MDF/MDF_NCA.csv';
des.IncludeCol = 'Include.GAD2';
des.model = ' ~ 1 + Group + Gender + I(poly(Age,degree=2)) + I(poly(meanFDpre,degree=2)) + Site'
%des.model = ' ~ 1 + Group + I(poly(Age,degree=2)) + I(poly(meanFDpre,degree=2))'
%des.model = ' ~ 1 + Group + Gender + I(poly(meanFDpre,degree=2))' 
%des.model = ' ~ 1 + Group + I(poly(meanFDpre,degree=2))' 
des.FxCol = 2;
des.FxFlip = 0;
...
CorrTemplate = '/net/pizza/CAAD/FirstLevel/[Subject]/Grid_all/Grid_all_corr.mat';
...
outputPath = '/net/pizza/CAAD/Jaime/NCA/ADvHC_Gender_AgeQuad_MotionQuad_Site';
%outputPath = '/home/slab/mnt/sopho/data/CAAD/Jaime/NCA/SADvHC_AgeQuad_MotionQuad';
%outputPath = '/home/slab/mnt/sopho/data/CAAD/Jaime/NCA/SADvHC_Gender_MotionQuad';
%outputPath = '/home/slab/mnt/sopho/data/CAAD/Jaime/NCA/SADvHC_MotionQuad';
outputPath = '/net/pizza/CAAD/Jaime/NCA/GADvHC_Gender_AgeQuad_MotionQuad_Site2';
...
ParamTemplate = '/net/pizza/CAAD/FirstLevel/CAAD004_scan1/Grid_all/Grid_all_parameters.mat';
...
mcRoot = '/home/slab/users/mangstad/repos/MethodsCore';
%DEVSTOP

%[DEVmcRootAssign]

addpath(genpath(fullfile(mcRoot,'svmbatch')));
addpath(genpath(fullfile(mcRoot,'matlabScripts'))); % if report error, add 'genpath' before fullfile)

addpath(fullfile(mcRoot,'spm8Batch'));
addpath(fullfile(mcRoot,'SPM','SPM8','spm8_with_R4667'));
addpath(fullfile(mcRoot,'MassUniConn'));
