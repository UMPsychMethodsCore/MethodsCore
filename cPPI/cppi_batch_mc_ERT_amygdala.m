...
LogTemplate = '[Exp]/matlabScripts/ERT/Logs/cPPI/';
...
'103',10,[1 2],0;
'107',11,[1 2],0;
%% '110',12,[1 2],0; %>3mm in both runs
%'111',13,[1 2],0;
%% '124',14,[1],0; %>3mm in run 2
%'133',15,[1 2],0;
%'137',16,[1 2],0;
%% '138',17,[1],0; %>3mm in run 2
'142',18,[1 2],0;
'143',19,[1 2],0;
'148',20,[1 2],0;
'153',21,[1 2],0;
...
%'174',28,[1 2],0;
%%'176',29,[1],0; %>3mm in run 2
'191',30,[1 2],0;
'200',31,[1 2],0;
'202',32,[1 2],0;
%%'203',33,[1 2],0; %>3mm in both runs
'206',34,[1 2],0;
'207',35,[1 2],0;
'218',36,[1 2],0;
%'219',37,[1 2],0;
...
'233',41,[1 2],0;
'235',42,[1 2],0;
%% '237',43,[1],0; %>3mm in run 2
'245',44,[1 2],0;
%%'251',45,[1],0; %>3mm in run 2
'256',46,[1 2],0;
%%'268',47,[1 2],0; %%% check?
%%'269',48,[1 2],0; %>3mm in both runs
'293',49,[1 2],0;
'331',50,[1 2],0;
'332',51,[1 2],0;
'344',52,[1 2],0;  
