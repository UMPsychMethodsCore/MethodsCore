...
opt.MasterDataFilePath = fullfile(pwd, 'MasterDataFiles/missing.csv');
...
opt.ContrastList = {
    'D4-M'      -10 1 1 [0 0 0 0 0 0];
    'D4-D1'     1 -1 10 [0 0 0 0 0 0];
    'test'      -10 0 1 [0 0 0 0 0 0];
    'test2'     0.5 0.5 -1 [0 0 0 0 0 0];
    'M'         1 0 0 [0 0 0 0 0 0];
