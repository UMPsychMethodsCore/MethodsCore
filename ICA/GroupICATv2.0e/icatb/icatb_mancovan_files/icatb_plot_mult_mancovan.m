function gH = icatb_plot_mult_mancovan(mancovanInfo)
...
for nRes = 1:length(res)
    ...
    cmap = hot;
    cmap = flipud(cmap); %cmap = cmap(1:size(hot, 1)*0.5,:); cmap = sqrt(cmap);
    ...
    vars = {logp, comp_str, start_terms, 'fig_title', ['Mancovan_', featureName], 'tag', ['Mancovan_', featureName], 'title', featureName, 'cmap', cmap, 'clim',  [0 -log10(eps)], 'xlabel', ...
