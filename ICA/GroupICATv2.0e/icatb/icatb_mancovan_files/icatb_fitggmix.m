...
%options = optimset('TolFun',1e-14, 'TolX', 1e-14, 'MaxFunEvals', 100000, 'LargeScale', 'off', 'LevenbergMarquardt', 'on');
options = optimset('TolFun',1e-14, 'TolX', 1e-14, 'MaxFunEvals', 100000, 'Display', 'off');
%P0 = [amp_gauss,               std_gauss, amp_gamma1,      exp_gamma1, decay_gamma1, exp_gamma2, decay_gamma2,];
%P0 = [max(YDATA),                 0.5,    max(YDATA)*.001,     2,           1,       2               1];
