...
elseif ((sesInfo.userInput.numOfSub*sesInfo.userInput.numOfSess > 1) && (sesInfo.userInput.numOfSub*sesInfo.userInput.numOfSess < 4))
    ...
    if (sesInfo.userInput.numReductionSteps > 3)
        sesInfo.userInput.numReductionSteps = 3;
    end
...
PCs = [sesInfo.userInput.numOfPC1, sesInfo.userInput.numOfPC2, sesInfo.userInput.numOfPC3];
