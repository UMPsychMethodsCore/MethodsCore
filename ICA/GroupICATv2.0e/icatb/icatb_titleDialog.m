...
% Name of the toolbox
text('units', 'normalized', 'string', 'Group ICA Toolbox', 'position', titlePos, 'fontsize', titleFont, 'HorizontalAlignment', 'center', ...
...
text('units', 'normalized', 'string', 'GroupICAT v2.0e', 'position', titlePos, 'fontsize', subtitleFont, 'HorizontalAlignment', 'center', ...
...
% authors
giftInfo = {'', '', ['\bfRelease Date: \rm', num2str('08-July-2011')], '', str2mat('\bfAuthors: \rm\bfVince Calhoun, \rm\bfTom Eichele, \rm\bfEric Egolf &', '                \rm\bfSrinivas Rachakonda'), ...
...
if strcmpi(toolbox_name, 'gift')
    ...
    D(size(D,2)+1).string = '5. Y. Li and Nicolle Correa at the University of Maryland Baltimore County.';
