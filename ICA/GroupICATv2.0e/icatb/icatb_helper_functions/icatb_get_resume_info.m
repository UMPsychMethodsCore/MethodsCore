...
for nStep = stepsToCheck
    ...
    if (nStep == 3)
        ...
        for j = 1:sesInfo.numReductionSteps
            ...
            dateInfo = str2mat(tmpFiles.date);
            tmpFiles2 = str2mat(tmpFiles.name);
            tmpFiles = tmpFiles2;
            ...
            if (isempty(tmpFiles))
                ...
                subjectsProcessed  = str2num(str2mat(strrep(cellstr(tmpFiles(:, 1:end-4)), tmpFileN, '')));
    ...
    if (nStep == 5)
        ...
        tmpFiles = dir(fullfile(sesInfo.outputDir, [tmpFileN, '*.mat']));
        dateInfo = str2mat(tmpFiles.date);
        tmpFiles = str2mat(tmpFiles.name);
