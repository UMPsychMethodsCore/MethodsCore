...
axis(origData.S5Handle, 'tight');
if (~strcmpi(icatb_get_modality, 'smri'))
    icatb_legend(origData.S5Handle, 'ICA TC at Max Voxel', 'ICA TC at Min Voxel', 'IC TC at Current Voxel', 0);
else
    icatb_legend(origData.S5Handle, 'ICA Loadings at Max Voxel', 'ICA Loadings at Min Voxel', 'IC Loadings at Current Voxel', 0);
end
...
if maxComp >= 5
    ...
    icatb_legend(['Component ',num2str(topComponents(1))],['Component ',num2str(topComponents(2))],...
        ['Component ',num2str(topComponents(3))],['Component ',num2str(topComponents(4))],['Component ',num2str(topComponents(5))],0);
    hold off;
    if (strcmpi(icatb_get_modality, 'fmri'))
