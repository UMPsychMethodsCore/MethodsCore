...
input_data_file_patterns = {'/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5024/Tx1/*.nii', '/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5024/Tx2/*.nii';
    '/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5025/Tx1/*.nii', '/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5025/Tx2/*.nii'};
...
input_design_matrices = {'/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5024/SPM.mat';
    '/net/dysthymia/slab/users/guosj/ICA/subject_MAS_MSIT/5025/SPM.mat'};
...
outputDir = '/net/dysthymia/slab/users/guosj/ICA/batch_results';

%% Enter Name (Prefix) Of Output Files
prefix = 'MAS_MSIT_noconcatenation';
