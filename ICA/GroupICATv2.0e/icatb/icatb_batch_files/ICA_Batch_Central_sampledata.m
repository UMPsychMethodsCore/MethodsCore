...
% %         for iRun = 1:length(RunDir)
% %             Subj = SubjDir{iSubj};
% %             Run = RunDir{iRun};
% %             input_data_file_patterns{iSubj, iRun} = mc_GenPath(InTemplate);
% %         end
% %     end
% % else
% %     for iSubj = 1:length(SubjDir)
% %             Subj = SubjDir{iSubj};
% %             input_data_file_patterns{iSubj,1} = mc_GenPath(InTemplate);
% %     end
% % end
...
OutTemplate.Template = OutTemplate;
OutTemplate.mode = 'makedir';
