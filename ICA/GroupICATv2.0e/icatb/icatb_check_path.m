...
reqdDirs = str2mat(giftPath, strcat(giftPath, filesep, str2mat('icatb_analysis_functions', 'icatb_batch_files', 'icatb_display_functions', ...
    'icatb_helpManual', 'icatb_helper_functions', 'icatb_io_data_functions', 'icatb_mex_files', 'icatb_talairach_scripts', 'icatb_spm8_files', ...
    'icatb_mancovan_files', ['toolbox', filesep, 'eegiftv1.0c'], ['toolbox', filesep, 'icasso122'], ['toolbox', filesep, 'mancovan'])));
