...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ImagePathTemplate = '[Exp]/Subjects/[Subject]/func/[Run]/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RegFilesTemplate = {
    '[Exp]/Subjects/[Subject]/func/[Run]/scripttest_ppi1v3.csv',Inf,0,1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputDir = '[Exp]/FirstLevel/[Subject]/MV_motion_deriv_ppi/';
