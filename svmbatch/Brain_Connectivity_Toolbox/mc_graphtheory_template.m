...
%%% Two ways: 1) Directly list the subjects; 
%%%           2) Extract subject list from cleansed MDF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subjpath = '/net/data4/Autism/GraphTheory/subj.mat';
Rcmd = ['Rscript --vanilla ' '~/users/yfang/MethodsCore/svmbatch/Brain_Connectivity_Toolbox/mc_getSubs.R --args ' '"'  subjpath '"' ' &> /dev/null'];
Rstatus = system(Rcmd);
s = load(subjpath);
s.Subject(:,3) = num2cell(1);
s.Subject(:,2) = num2cell(1);
SubjDir = s.Subject;
