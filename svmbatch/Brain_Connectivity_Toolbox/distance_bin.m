...
%       Lengths on the main diagonal are set to 0.  %%%% @ YU: does not seem
%       work, will try to fix that.  1-29: fixed
%
...
% D=D-eye(length(G));    @Yu
D(eye(size(D))~=0)=0;    % @Yu Set the diagonal distance as 0 (consistent with the header comment of this function)